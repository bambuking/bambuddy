export default {
  ...
  settings: {
    ...
    axisLimits: {
      title: '軸リミット',
      description: 'ダッシュボードのジョグ操作で使用する移動安全範囲を調整します。初期値は Bambu Lab の仕様に基づいています。より厳しい制限が必要な場合のみ変更してください。',
      defaultEnvelope: 'Bambu Lab 初期値',
      sharedNozzleEnvelope: 'すべてのノズルモードで共通の安全領域です。',
      custom: 'カスタム',
      resetAll: 'すべてリセット',
      axisLimit: '軸リミット',
      rangeHint: '値はミリメートル単位で保存されます。許可範囲: 1-{{max}} mm。',
      invalid: '各軸に 1 から {{max}} mm の値を入力してください。',
    },
    spoolbuddy: {
