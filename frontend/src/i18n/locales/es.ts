export default {
  ...
  settings: {
    ...
    axisLimits: {
      title: 'Límites de ejes',
      description: 'Ajusta el área de seguridad que utilizan los controles de movimiento del panel. Los valores predeterminados coinciden con las especificaciones de Bambu Lab; cámbialos solo si tu instalación requiere límites más estrictos.',
      defaultEnvelope: 'Valor predeterminado de Bambu Lab',
      sharedNozzleEnvelope: 'Área segura compartida para todos los modos de boquilla.',
      custom: 'Personalizado',
      resetAll: 'Restablecer todo',
      axisLimit: 'límite del eje',
      rangeHint: 'Los valores se guardan en milímetros. Intervalo permitido: 1-{{max}} mm.',
      invalid: 'Introduce un valor entre 1 y {{max}} mm para cada eje.',
    },
    spoolbuddy: {
