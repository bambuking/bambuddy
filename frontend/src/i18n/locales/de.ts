export default {
  ...
  settings: {
    ...
    axisLimits: {
      title: 'Achsenlimits',
      description: 'Passe den Bewegungsbereich an, den die Jog-Steuerung im Dashboard als Sicherheitsgrenze verwendet. Die Standardwerte entsprechen den Bambu-Lab-Spezifikationen; ändere sie nur, wenn dein Druckeraufbau strengere Grenzen benötigt.',
      defaultEnvelope: 'Bambu-Lab-Standard',
      sharedNozzleEnvelope: 'Gemeinsamer sicherer Bereich für alle Düsenmodi.',
      custom: 'Angepasst',
      resetAll: 'Alle zurücksetzen',
      axisLimit: 'Achsenlimit',
      rangeHint: 'Die Werte werden in Millimetern gespeichert. Zulässiger Bereich: 1-{{max}} mm.',
      invalid: 'Gib für jede Achse einen Wert zwischen 1 und {{max}} mm ein.',
    },
    spoolbuddy: {
