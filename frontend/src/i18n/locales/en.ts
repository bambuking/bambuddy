export default {
  ...
  settings: {
    ...
    axisLimits: {
      title: 'Axis Limits',
      description: 'Adjust the motion safety envelope used by dashboard jog controls. Defaults match Bambu Lab specifications; only change them when your printer setup requires a stricter limit.',
      defaultEnvelope: 'Bambu Lab default',
      sharedNozzleEnvelope: 'Shared safe area for all nozzle modes.',
      custom: 'Custom',
      resetAll: 'Reset all',
      axisLimit: 'axis limit',
      rangeHint: 'Values are saved in millimeters. Allowed range: 1-{{max}} mm.',
      invalid: 'Enter a value between 1 and {{max}} mm for every axis.',
    },
    spoolbuddy: {
