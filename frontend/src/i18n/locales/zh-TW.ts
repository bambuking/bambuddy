export default {
  ...
  settings: {
    ...
    axisLimits: {
      title: '軸限位',
      description: '調整儀表板點動控制使用的安全移動範圍。預設值符合 Bambu Lab 規格；僅在印表機安裝需要更嚴格限制時修改。',
      defaultEnvelope: 'Bambu Lab 預設值',
      sharedNozzleEnvelope: '所有噴嘴模式共用的安全區域。',
      custom: '自訂',
      resetAll: '全部重設',
      axisLimit: '軸限位',
      rangeHint: '數值以毫米儲存。允許範圍：1-{{max}} mm。',
      invalid: '請為每個軸輸入 1 到 {{max}} mm 之間的數值。',
    },
    spoolbuddy: {
