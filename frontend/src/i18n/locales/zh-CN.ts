export default {
  ...
  settings: {
    ...
    axisLimits: {
      title: '轴限位',
      description: '调整仪表板点动控制使用的安全移动范围。默认值符合 Bambu Lab 规格；仅在打印机安装需要更严格限制时修改。',
      defaultEnvelope: 'Bambu Lab 默认值',
      sharedNozzleEnvelope: '所有喷嘴模式共用的安全区域。',
      custom: '自定义',
      resetAll: '全部重置',
      axisLimit: '轴限位',
      rangeHint: '数值以毫米保存。允许范围：1-{{max}} mm。',
      invalid: '请为每个轴输入 1 到 {{max}} mm 之间的数值。',
    },
    spoolbuddy: {
